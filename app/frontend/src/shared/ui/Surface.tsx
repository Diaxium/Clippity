...
/**
 * Surface variants map 1:1 to the `.glass-*` and `.surface-*` classes
 * in `theme.css`. Centralizing the variant→class mapping here means
 * callers say `<Surface variant="elevated" />` instead of memorizing
 * the class name catalog.
 */
